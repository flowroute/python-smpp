...
from smpp.pdu import encode_pdu, pack_pdu
...
class BindTransmitter(Bind):
    def __init__(
        ...
        super(BindTransmitter, self).__init__(
            'bind_transmitter', sequence_number, **kwargs)
...
class BindReceiver(Bind):
    def __init__(
            ...
            sequence_number,
            **kwargs):
        super(BindReceiver, self).__init__(
            'bind_receiver', sequence_number, **kwargs)
...
class BindTransceiver(Bind):
    def __init__(
            ...
            sequence_number,
            **kwargs):
        super(BindTransceiver, self).__init__(
            'bind_transceiver', sequence_number, **kwargs)
...
class BindTransmitterResp(BindResp):
    def __init__(
            ...
            **kwargs):
        super(BindTransmitterResp, self).__init__(
            'bind_transmitter_resp', command_status, sequence_number, **kwargs)
...
class BindReceiverResp(BindResp):
    def __init__(
            ...
            command_status="ESME_ROK",
            **kwargs):
        super(BindReceiverResp, self).__init__(
            'bind_receiver_resp', command_status, sequence_number, **kwargs)
...
class BindTransceiverResp(BindResp):
    def __init__(
            ...
            command_status="ESME_ROK",
            **kwargs):
        super(BindTransceiverResp, self).__init__(
            'bind_transceiver_resp', command_status, sequence_number, **kwargs)
...
class Unbind(PDU):
    def __init__(
        ...
        super(Unbind, self).__init__(
            'unbind', 'ESME_ROK', sequence_number, **kwargs)
...
class SubmitMulti(SM1):
    def __init__(
            ...
            dest_address=[],
            **kwargs):
        super(SubmitMulti, self).__init__(
            'submit_multi', sequence_number, **kwargs)
    ...
    def addDestinationAddress(
        ...
        if isinstance(destination_addr, str) and len(destination_addr) > 0:
            ...
            mandatory_parameters['number_of_dests'] = \
                len(mandatory_parameters['dest_address'])
            return True
        else:
            return False
...
class DeliverSM(SM2):
    def __init__(
            ...
            sequence_number,
            **kwargs):
        super(DeliverSM, self).__init__(
            'deliver_sm', sequence_number, **kwargs)
...
class EnquireLinkResp(PDU):
    def __init__(
        ...
        super(EnquireLinkResp, self).__init__(
            'enquire_link_resp', 'ESME_ROK', sequence_number, **kwargs)
...
class QuerySM(PDU):
    def __init__(
        ...
        super(QuerySM, self).__init__(
            'query_sm', 'ESME_ROK', sequence_number, **kwargs)
        self.obj['body'] = {
            'mandatory_parameters': {
                'message_id': message_id,
                'source_addr': source_addr,
