...
from smpp.pdu_inspector import detect_multipart, MultipartMessage
...
class MultipartTestCase(unittest.TestCase):
    ...
    def test_real_csm_data(self):
        ...
        asif_1 = {
            'body': {
                'mandatory_parameters': {
                    ...
                    'sm_default_msg_id': 0,
                    'validity_period': '',
                    'destination_addr': '261xxx782943',
                    'short_message': (
                        '\x05\x00\x03\x1a\x02\x01I try to send sms testing '
                        'vumi sms sms sms sms msm sms sms sms sms sms sms sms '
                        'sms sms ssms sms smS sms sms sms sms sms sms sms sns '
                        'sns sms sms sms sms s')
                },
                'optional_parameters': [
                    {
                        'length': 2,
                    ...
                    },
                    {
                        'length': 16,
                        'tag': 'dest_subaddress',
                        'value': 'a0000410020601030303070802090403'
                    }
                ]
            },
            'header': {
        ...
        asif_2 = {
            'body': {
                'mandatory_parameters': {
                    ...
                    'destination_addr': '261xxx782943',
                    'short_message': (
                        '\x05\x00\x03\x1a\x02\x02mns again again again again'
                        ' again again again again sms sms sms sms sms ')
                },
                'optional_parameters': [
                    {
                        'length': 2,
        ...
        self.assertEquals(
            multi.get_partial(),
            {
                'to_msisdn': '261xxx782943',
                'from_msisdn': '261xxx720371',
                'message': (
                    'mns again again again again again again again '
                    'again sms sms sms sms sms ')
            })
        self.assertEquals(multi.get_completed(), None)
        ...
        self.assertEquals(
            multi.get_completed()['message'],
            ('I try to send sms testing vumi sms sms sms sms msm sms '
             'sms sms sms sms sms sms sms sms ssms sms smS sms sms sms sms '
             'sms sms sms sns sns sms sms sms sms smns again again again '
             'again again again again again sms sms sms sms sms '))
        self.assertEquals(multi.get_key(), '261xxx720371_261xxx782943_26_2')
